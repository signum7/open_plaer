...
function RandomRangeMT19937(const AFrom, ATo: Integer): Integer;// Antonenko 05.2020 !
...
function RandomRangeMT19937(const AFrom, ATo: Integer): Integer;
begin
  //randomize_MT19937;
  if AFrom > ATo then
    Result := randInt_MT19937(AFrom - ATo) + ATo
  else
    Result := randInt_MT19937(ATo - AFrom) + AFrom;
end;
